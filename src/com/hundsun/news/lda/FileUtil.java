...
public class FileUtil {
	...
	public static Map<String, Integer> readMapfromFile(String filePath, String fileName) throws IOException{
	...
	/*
	 * 从文章中读取做rankscore后的结果
	 */
	public static Map<Integer, Double> readTopicRankScoreMapfromFile(String filePath,
			String fileName){
		Map<Integer, Double> topicRankScoreMap = new HashMap<Integer, Double>();
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				...
				topicRankScoreMap.put(key, value);
			}
		...
		return topicRankScoreMap;
	}
	
	/**
	 *浠庢枃浠朵腑璇诲彇map锛圛DFScoreMap)
	 * @return rankScoreMap
	 */
	public static Map<String, Double> readWordIDFMapfromFile(String filePath,
			String fileName){
		Map<String, Double> wordRankScoreMap = new HashMap<String, Double>();
		...
		try {
			...
			String line = null;
			while ((line = reader.readLine()) != null) {
				String key = String.valueOf(line.split(":")[0]);
				Double value = Double.valueOf(line.split(":")[1]);
				wordRankScoreMap.put(key, value);
			}
	...
	public static Double[][] readMatrixFromFile(String filePath, String fileName) throws IOException  {
	...
	public static void writeLines(String filePath, ArrayList<?> counts) {
		BufferedWriter writer = null;
